...
class SaleOrder(models.Model):
    ...
    tot_products = fields.Integer(string='Total Productos:', compute='_compute_total_products')
    tot_qty = fields.Float(string='Cantidad Total', compute='_compute_sum_quantity')
